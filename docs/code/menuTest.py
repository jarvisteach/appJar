...
app.addMenuRadioButton("Test 3", "RBBB", "RB3")
app.addMenuRadioButton("Test 2", "RBBB", "RB1")
app.addMenuRadioButton("Test 2", "RBBB", "RB2")
app.addMenuRadioButton("Test 2", "RBBB", "RB3")
app.addMenuRadioButton("Test 2", "RBBB", "RB4")
app.addMenuRadioButton("Test 2", "RBBB", "RB5")
app.addMenuRadioButton("Test 2", "RBBB", "RB6")
app.addMenuRadioButton("Test 2", "RBBB", "RB7")
app.addMenuItem("Test 2", "-")
