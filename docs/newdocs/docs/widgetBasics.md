...
The biggest change in appJar 1.0 is the introduction of a single function for **ADD**ing, **SET**ting and **GET**ting widgets:  
...
with gui("Version 1.0", bg="teal") as app:
    ...
    # group the buttons into a labelframe
...
![SimpleAppJar](img/simpleDemo.png#right)
As can be seen, this has created a GUI, 7 widgets, and one container using 9 lines of code. All styling of the widgets has been done in the creation of the widget.  
