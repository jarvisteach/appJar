...
* <div class="cb cb-new">New</div>function to lift/lower widgets [WidgetManipulation](/pythonWidgetOptions/#widget-manipulation) - [#607](https://github.com/jarvisteach/appJar/issues/607)
* <div class="cb cb-new">New</div>feature to [redirect output](/pythonOutputRedirection.md) (print) to a TextArea - [#606](https://github.com/jarvisteach/appJar/issues/606)
* <div class="cb cb-new">New</div>feature to find out which window is in [focus](/simpleProperties/#gui-settings) - [#510](https://github.com/jarvisteach/appJar/issues/510)
...
* <div class="cb cb-imp">Improved</div>[Buttons](/inputWidgets/#button) rudimentary support for disabled backgrounds - [#579](https://github.com/jarvisteach/appJar/issues/579)  
* <div class="cb cb-imp">Improved</div>[Meters](/simpleAppJar/#meter) can now be drawn horizontally - [#532](https://github.com/jarvisteach/appJar/issues/532)  
* <div class="cb cb-imp">Improved</div>[autoEntry](/inputWidgets/#entry), drop-down now goes outside the GUI window - [#139](https://github.com/jarvisteach/appJar/issues/139)  
* <div class="cb cb-fix">Fixed</div>[Sliders](/simpleAppJar/#slider), they now correctly receive a value - [#601](https://github.com/jarvisteach/appJar/issues/601)
...
* <div class="cb cb-fix">Fixed</div>warnings when destroying [tables](/pythonDevWidgets/#table) - [#584](https://github.com/jarvisteach/appJar/issues/584)
* <div class="cb cb-fix">Fixed</div>[Google Maps](/outputWidgets/#googlemaps) location services - [#566](https://github.com/jarvisteach/appJar/issues/566)
* <div class="cb cb-fix">Fixed</div>[Google Maps](/outputWidgets/#googlemaps) API keys - [#557](https://github.com/jarvisteach/appJar/issues/557)
...
* <div class="cb cb-fix">Fixed</div>[Tooltips](/pythonDialogs/#tooltips), they now work on bundled TKinter - [#541](https://github.com/jarvisteach/appJar/issues/541)
