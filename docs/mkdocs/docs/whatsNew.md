...
* <div class="change-badge change-badge-fixed">Fixed</div>[Menu check boxes](/pythonBars/#menubar) now toggle using the keyboard shortcut, and also work properly on Mac - [#512](https://github.com/jarvisteach/appJar/issues/512)
