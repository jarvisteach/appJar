...
* Issues Resolved:
    ...
    * [#71](https://github.com/jarvisteach/appJar/issues/71) - More work on [Internationalisation](/pythonInternationalisation/) - now supports LabelFrames, ToggleFrames, TabbedFrames, Properties, Grids, Toolbars, SubWindows, SplashScreens & Titles  
