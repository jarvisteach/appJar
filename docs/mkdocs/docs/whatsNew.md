...
* <div class="cb cb-add">Added</div> the ability to lift/lower widgets [WidgetManipulation](/pythonWidgetOptions/#widget-manipulation) - [#607](https://github.com/jarvisteach/appJar/issues/607)
