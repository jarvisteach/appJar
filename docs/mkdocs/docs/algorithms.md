...
Selection:<br>Greater than | ![Selection-GT](img/algorithms/6_a_gt_b.png) | IF a &gt; b THEN<br>funcA()<br>ELSE<br>funcB()<br>ENDIF | a &gt; b:<br>funcA()<br>else:<br>funcB() | LDA b<br>SUB a<br>BRP funcA<br>BRA funB | 5xx<br>2xx<br>8xx<br>6xx 
Selection:<br>Less than | ![Selection-LT](img/algorithms/7_a_lt_b.png) | IF a &lt; b THEN<br>funcA()<br>ELSE<br>funcB()<br>ENDIF | a &lt; b:<br>funcA()<br>else:<br>funcB() | LDA a<br>SUB b<br>BRP funcB<br>BRA funcA | 5xx<br>2xx<br>8xx<br>6xx
Selection:<br>Equal to | ![Selection-EQ](img/algorithms/8_a_eq_b.png) | IF a = b THEN<br>funcA()<br>ELSE<br>funcB()<br>ENDIF | if a == b:<br>funcA()<br>else:<br>funcB() | LDA a<br>SUB b<br>BRZ funcA<br>BRA funcB | 5xx<br>2xx<br>7xx<br>6xx
Selection:<br>Not equal to | ![Selection-NEQ](img/algorithms/9_a_ne_b.png) | IF a &#8800; b THEN<br>funcA()<br>ELSE<br>funcB()<br>ENDIF | if a &#8800; b:<br>funcA()<br>else:<br>funcB() | LDA a<br>SUB b<br>BRZ funcB<br>BRA funcA | 5xx<br>2xx<br>7xx<br>6xx
Iteration:<br>While loop | ![Iteration-WHILE](img/algorithms/.png) | | | | 
Iteration:<br>For loop (count-up) | ![Iteration-FOR_UP](img/algorithms/.png) | | | | 
Iteration:<br>For loop (count-down) | ![Iteration-FOR_DOWN](img/algorithms/.png) | | | | 
